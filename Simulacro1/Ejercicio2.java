 ...
 * este código automatiza esta funcion y la hace mas rapida y sencilla, además
 * tambien evita la entrada erronea de datos
 * 
...
public class Ejercicio2 { 
  public static void main(String[] args) {
    ...
    //Comprobante de que se cumple el pedido mínimo, repite el proceso hasta que el
    //numero introducido es apto
    while (polo<20) {
      System.out.println("");
      System.out.println("Cantidad de polos introducida erronea, recuerda que el mínimo son 20");
      System.out.print("Cantidad de polos: ");
      polo = Integer.parseInt(System.console().readLine());
    }
    ...
    //Comprobante que se encarga de comprobar que los numeros estan bien seleccionados
    while (color < 0 || color > 2){
      System.out.println("");
      System.out.println("Número introducido, vuelva a leer las 2 posibilidades");
      System.out.print("> ");
      System.out.print("");
    ...
    //Comprobante que se encarga de comprobar que los numeros estan bien seleccionados
    while (serografia < 0 || serografia > 2){
      System.out.println("");
      System.out.println("Número introducido, vuelva a leer las 2 posibilidades");
      System.out.print("> ");
      System.out.print("");
      serografia = Integer.parseInt(System.console().readLine());
    }
